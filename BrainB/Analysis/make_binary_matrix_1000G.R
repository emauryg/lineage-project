## R code to create a new binary matrix with the 1000G filtration step
...
# Binary matrix can then be used on a similar code as the one ran previously for the clusterin
